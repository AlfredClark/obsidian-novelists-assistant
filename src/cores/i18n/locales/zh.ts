...
export const zh: TranslationResource = {
  settings: {
    ...
    novelTypesetting: "正文排版",
    novelTypesettingDesc: "对正文目录内的文件应用排版样式",
    typesetting: "排版设置",
    typesettingDesc: "配置正文目录内文件的排版样式",
  },
  structure: {
    created: "已创建文件夹：{dirs}",
    defaultLore: "设定",
...
export const zhTW: TranslationResource = {
  settings: {
    ...
    novelTypesetting: "正文排版",
    novelTypesettingDesc: "對正文目錄內的檔案套用排版樣式",
    typesetting: "排版設定",
    typesettingDesc: "設定正文目錄內檔案的排版樣式",
  },
  structure: {
    created: "已建立資料夾：{dirs}",
    defaultLore: "設定",
